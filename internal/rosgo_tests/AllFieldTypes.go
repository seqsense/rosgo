// Automatically generated from the message definition "rosgo_tests/AllFieldTypes.msg"
...
const (
	AllFieldTypes_FOO  byte   = 1
	AllFieldTypes_BAR  byte   = 2
	AllFieldTypes_HOGE string = "hoge"
)
